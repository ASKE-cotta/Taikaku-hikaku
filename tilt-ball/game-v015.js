...
var running=false,last=performance.now(),gameMinutes=D.initialMinutes,damage=0,invuln=0,impactFx=null;
...
function resetGame(){
  ...
  gameMinutes=D.initialMinutes;damage=0;invuln=0;impactFx=null;currentNode=D.start;currentEdge=null;edgeProgress=0;nextHazard=0;hazards=[];pendingPatterns=[];lastEncounterLabels=[];flowDir=1;terrainHitCooldown=0;encounterIndex=0;
